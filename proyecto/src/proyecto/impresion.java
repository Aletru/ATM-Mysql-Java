 ...
 bd cc=new bd();
  Connection con=(Connection) cc.conexion();
    ...
    private void initComponents() {
        ...
        jPanel1.add(sdl, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, 147, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     try {
        String sql = "select * from prueba where saldo=?";
        PreparedStatement st= con.prepareStatement(sql);
        st.setInt(1, 500);
        ResultSet rs= st.executeQuery();
        while(rs.next()){
            int saldo=rs.getInt(1);
            String sd=String.valueOf(saldo);
            sdl.setText(sd);
        }
     } catch (Exception e) {
